...
# product_analyze_v1
#
# Two things in this text are load-bearing rather than stylistic, and both come
# straight from §14:
#
# 1. The instruction to put anything unconfirmed in `uncertain_fields` instead
#    of guessing. A model asked to fill a schema will fill it — inventing a
#    material rather than leaving a blank — so the schema has to offer somewhere
#    honest to put "I cannot tell".
# 2. The separation between what is visible and what is speculation. The
